...
public class Main {
    ...
    private static void initiateMenu() {
        Passenger adit = new Passenger("Adit", "adit@gmail.com", 100000.0D);
        Passenger surya = new Passenger("Surya", "surya@gmail.com", 20000.0D);
        Passenger krismon = new Passenger("Krismon", "krismon@gmail.com", 10000.0D);
